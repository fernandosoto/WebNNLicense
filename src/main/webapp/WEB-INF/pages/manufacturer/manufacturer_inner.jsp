	...
	<section class="main clearfix">
		...
		<section class="top">	
			<div class="wrapper content_header clearfix">
				...
				<h1 class="title">Add/Modify manufacturer</h1>
			</div>		
		</section><!-- end top -->
		...
		<section class="wrapper">
			<div class="content">
				...
				<form:form commandName="manufacturerForm" method="POST">
					...
					<nav>
						<ul>
							<li><form:radiobutton path="radioButtonSelect" name="group1" value="manufacturer_add" checked="checked"/> Add manufacturer<br><br></li>
							<li><form:radiobutton path="radioButtonSelect" name="group1" value="manufacturer_modify"/> Modify manufacturer<br><br></li>
