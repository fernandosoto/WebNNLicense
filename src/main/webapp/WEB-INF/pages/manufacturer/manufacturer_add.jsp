		...
		<section class="wrapper">
			<div class="content">
				...
				<form:form commandName="manufacturerForm" method="POST">
					...
					<nav>
						<ul>
							<li><br>Manufacturer name: <form:input path="manufacturer.name" type="text" maxlength="50"/></li>
							<li><br>Comments: <form:textarea path="manufacturer.freeText" rows="5" cols="80" maxlength="300"/></li>
