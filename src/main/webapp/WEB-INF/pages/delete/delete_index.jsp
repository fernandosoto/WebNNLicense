...
<section class="main clearfix">
  ...
  <section class="wrapper">
    ...
    <br>
    <br>
    <ul style="list-style: none;"> <!-- Ej punkt lista -->

      <li> <form:radiobuttons items="${labels}" path="deleteForm.radioButtonSelect" element="li"></form:radiobuttons>
        <br>
        <br>
        <FORM action="delete_inner"><INPUT type="submit" value="Ok"><a href="delete_inner" ></a></FORM>
      </li>
    </ul>
