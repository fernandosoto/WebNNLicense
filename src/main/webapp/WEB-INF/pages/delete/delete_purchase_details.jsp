	...
	<section class="main clearfix">
		...
		<section class="top">	
			<div class="wrapper content_header clearfix">
				...
				<h1 class="title">Delete purchase</h1>
			</div>		
		</section><!-- end top -->
				...
				<form:form commandName="deleteForm" method="POST">
					...
					<nav>
						<ul>
							...
							<li><br>Serial Keys:<br><form:select path="" title="Licenses" size="6" disabled="true" style="width: 400px; background-color:#f6f6f6;" multiple="true">
								<form:options items="${licenses}" title="Available licenses"/>
							</form:select></li>
							<li><br><input type="submit"  value="Delete Purchase" onclick="alert('Purchase deleted!');"/></li>
						</ul>
					</nav><!-- end navigation menu -->
					</fieldset>
					</div>
