...
<head>
	...
	<title>Nordnet - Distributor</title>
	<meta charset="utf-8">
	...
	<section class="main clearfix">
		...
		<section class="top">	
			<div class="wrapper content_header clearfix">
				...
				<h1 class="title">Add/Modify distributor</h1>
			</div>		
		</section><!-- end top -->
		...
		<section class="wrapper">
			<div class="content">
				...
				<form:form commandName="distributorForm" method="POST">

					<nav>
						<ul>
							<li><form:radiobutton path="radioButtonSelect" name="group1" value="distributor_add" checked="checked"/> Add distributor<br><br></li>
							<li><form:radiobutton path="radioButtonSelect" name="group1" value="distributor_modify"/> Modify distributor<br><br></li>
