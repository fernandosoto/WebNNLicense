	...
	<section class="main clearfix">
		...
		<section class="top">	
			<div class="wrapper content_header clearfix">
				...
				<h1 class="title">Add Distributor</h1>
			</div>		
		</section><!-- end top -->
		...
		<section class="wrapper">
			<div class="content">
				...
				<form:form commandName="distributorForm" method="POST">
					...
					<nav>
						<ul>
							<li><br>Distributor name: <form:input path="distributor.name" type="text" maxlength="50"/></li>
							<li><br>Comments: <form:textarea path="distributor.freeText" rows="5" cols="80" maxlength="300"/></li>
